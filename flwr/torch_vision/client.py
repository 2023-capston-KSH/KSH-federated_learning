...
class CifarClient(fl.client.NumPyClient):
	...
	def fit(self, parameters, config):
		...
		results = utils.train(model, trainLoader,
							  valLoader, epochs, self.device)
...
def main(args: argparse.Namespace) -> None:
	...
	if args.dry:
		...
		trainset, testset = utils.load_partition(args.partition, args.dataset)
...
if __name__ == "__main__":
	...
	parser.add_argument(
		...
		required=False,
		help="Specify the server address. Default: 127.0.0.1:8080",
	)
